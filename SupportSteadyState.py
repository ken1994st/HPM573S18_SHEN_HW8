...
def print_outcomes(sim_output, name):
...
def print_comparative_outcomes(sim_output_head, sim_output_tail):
    ...
    increase = Stat.DifferenceStatIndp(
        ...
        x=sim_output_head.get_rewards(),
        y_ref=sim_output_tail.get_rewards()
    )
    # estimate and CI
